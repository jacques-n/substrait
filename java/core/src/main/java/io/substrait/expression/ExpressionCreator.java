...
public class ExpressionCreator {
  ...
  public static Expression.ScalarFunctionInvocation ifThenStatement(SimpleExtension.ScalarFunctionVariant declaration, Type outputType, Expression...arguments) {
  ...
  public static Expression.ScalarFunctionInvocation ifThenStatement(SimpleExtension.ScalarFunctionVariant declaration, Type outputType, Iterable<? extends Expression> arguments) {
  ...
  public static AggregateFunctionInvocation ifThenStatement(
