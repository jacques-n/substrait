...
public abstract class DelegatingIRMQ implements IRelMetadataQuery {
  static final org.slf4j.Logger logger = org.slf4j.LoggerFactory.getLogger(DelegatingIRMQ.class);

  private final IRelMetadataQuery delegate;

  public DelegatingIRMQ(IRelMetadataQuery delegate) {
